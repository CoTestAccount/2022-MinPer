...
def load_permission_info():
    ...
    #f = '/Users/***/Documents/Code/overclaim_tap/oauth/permission_detail_ana/permissions_range_modified.txt'
    f = '/Users/***/Documents/Code/overclaim_tap/oauth/permission_detail_ana/permissions_range_modified_v2.txt'
...
def load_operation_nn():
    ...
    path = "/Users/***/Documents/Code/overclaim_tap/channel_api/channel_api_nn.txt"
    lines = open(path, "r")
    for line in lines:
        nn_array = []
...
if __name__ == "__main__":
    ...
    #load_permission_info()


    #selected = ["adafruit"]
    selected = fetch_seed_benchmark()
