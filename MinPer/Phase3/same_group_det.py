...
sys.path.insert(1, '/Users/liuhuo/Documents/Code/overclaim_tap/nn_overclaim')
from nn_frequency import load_services_group
sys.path.insert(1, '/Users/liuhuo/Documents/Code/overclaim_tap/stanford_parser')
from atomic_operation import parse_sentence_verb_obj_pair
sys.path.insert(1, '/Users/liuhuo/Documents/Code/overclaim_tap/verb_overclaim')
...
def fetch_negtive():
    ...
    file = '/Users/liuhuo/Documents/Code/overclaim_tap/oauth/permission_detail_ana/negative_permission.txt'
    service_name = ''
    permissions = []
